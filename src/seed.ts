...
export const PERMISSION_VOCABULARY: PermissionInfo[] = [
  ...
  { key: "intel.read", product: "intel", description: "View Intel study runs and findings" },
  { key: "intel.study", product: "intel", description: "Trigger Intel study runs" },
  { key: "intel.review", product: "intel", description: "Accept or reject Intel findings" },
  { key: "intel.manage", product: "intel", description: "Manage Intel configuration" },
